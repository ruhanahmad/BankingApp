...
class CodeFieldLogin extends StatefulWidget {
   CodeFieldLogin({Key? key,}) : super(key: key);
 
  @override
  _CodeFieldLoginState createState() => _CodeFieldLoginState();
}

class _CodeFieldLoginState extends State<CodeFieldLogin> {
...
phoneAuth.verifyPhoneAgain();
         ...
         var saved = await prefs.setBool('LoginInfo',true);
