...
import 'package:bnacash/pages/create_bene.dart';
...
class ReasonPayment extends StatefulWidget {
  const ReasonPayment({Key? key}) : super(key: key);

  @override
  State<ReasonPayment> createState() => _ReasonPaymentState();
}

class _ReasonPaymentState extends State<ReasonPayment> {
                  ...
                  child: Row(
                   ...
                   Column(
                        ...
                        children: [
                          ...
                          Text("TND"),
                          Text(userController.sendMoneyBalance),
                        ],
                      ),
...
DropdownButton(
      ...
      iconSize: 30.0,
      style: TextStyle(color: Colors.blue),
      items: ['Family Support', 'Consutruction', 'Pension'].map(
        (val) {
      ...
      onChanged: (val) {
        setState(
         ...
         Nav.toScreen(context, const CreateBene());
           }
